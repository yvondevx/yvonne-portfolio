      ...
      >
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="text-white font-semibold text-sm">Yvonne&apos;s Assistant</p>
              ...
              <div className="max-w-[80%]">
                {msg.role === "bot" && (
                  <div className="flex items-end gap-2">
                    <div className="w-6 h-6 rounded-full flex-shrink-0 flex items-center justify-center text-xs mb-1"
                      style={{ background: "linear-gradient(135deg, #fce7f3, #f9a8d4)" }}>
                      👩‍💻
                    </div>
                    <div>
                      <div className="chat-bubble-bot px-4 py-2.5 text-sm leading-relaxed">{msg.text}</div>
                ...
                {msg.role === "user" && (
                  <div className="flex flex-col items-end">
                    <div className="chat-bubble-user px-4 py-2.5 text-sm leading-relaxed">{msg.text}</div>
                    <p className="text-xs text-gray-400 mt-1 mr-1">{msg.time}</p>
                  </div>
                )}
              </div>
            </div>
